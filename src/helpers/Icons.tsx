...
const Star = ({color}:{color: boolean}) => {
    let className: string = color ? "yellow-bg": ""
    return(
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill={"currentColor"} 
        className={`bi bi-star-fill margin-bot-icon ` + className} viewBox="0 0 16 16">
...
export { Cart, Star, Edit, Bin, QuestionMark }